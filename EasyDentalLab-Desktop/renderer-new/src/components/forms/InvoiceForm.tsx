...
import type { Invoice, AppData, LineItem, Client } from '../../types';
...
export function InvoiceForm({ invoice, data, onSave, onCancel, onDirtyChange, onSaveClient }: InvoiceFormProps) {
